module.exports = ({ workoutActivityType, duration, totalDistance, totalEnergyBurned, sourceName, sourceVersion, creationDate, startDate, endDate }) => {
  return {
    ...
    totalEnergyBurned: parseFloat(totalEnergyBurned),
    sourceName,
    sourceVersion,
